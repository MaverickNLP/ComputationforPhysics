...
plot_mass_1_1, = ax.plot(positions_1[0], positions_1[1], positions_1[2], label="Sun", linewidth=0.5, color = '#ff9999', alpha=0.9)
plot_mass_2_1, = ax.plot(positions_2[0], positions_2[1], positions_2[2], label="Earth", linewidth=0.5, color = '#66b3ff', alpha=0.9)
plot_mass_3_1, = ax.plot(positions_3[0], positions_3[1], positions_3[2], label="Moon", linewidth=0.5, color = '#99ff99', alpha=0.9)
plot_mass_1_2, = ax.plot(positions_1[0], positions_1[1], positions_1[2], 'o', color = '#ff9999', alpha=0.9, markersize = 2)
plot_mass_2_2, = ax.plot(positions_2[0], positions_2[1], positions_2[2], 'o', color = '#66b3ff', alpha=0.9, markersize = 2)
plot_mass_3_2, = ax.plot(positions_3[0], positions_3[1], positions_3[2], 'o', color = '#99ff99', alpha=0.9, markersize = 2)
fig.legend()
ax.set_title("Figure 1b: Simple Solar System", font = cm)
...
ani.save("P1b: Earth, Sun, and Moon System.gif", fps = 20)
print("ended")

# You can't see the Earth's orbit since the orbit of the Earth and Moon are essentially the same at this scale. 