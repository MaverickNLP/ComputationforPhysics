...
plot_mass_2_1, = ax.plot(positions_2[0], positions_2[1], positions_2[2], label="Earth", linewidth=1, color = '#66b3ff', alpha=0.9)
plot_mass_3_1, = ax.plot(positions_3[0], positions_3[1], positions_3[2], label="Moon", linewidth=1, color = '#99ff99', alpha=0.9)
...
fig.legend()
ax.set_title("Figure 1a: The Earth and Moon Under the Influence of the Sun", font = cm)
...
ani.save("P1a: Earth, Sun, and Moon System.gif", fps = 20)
print("ended")