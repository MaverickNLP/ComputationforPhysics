...
fig_1 = plt.figure()
plt.title("Figure 2b: The X Momenta of the Body 2, Body 1, and Body 3", font = cm)
plt.xlabel("Time (s)", font = cm)
plt.ylabel("Momentum (kgm/s)", font = cm)
plt.plot(time_array, momentum_1[0, 1:], label = "X Momentum of the Body 1")
plt.plot(time_array, momentum_2[0, 1:], label = "X Momentum of the Body 2")
plt.plot(time_array, momentum_3[0, 1:], label = "X Momentum of the Body 3")
...
fig_2 = plt.figure()
plt.title("Figure 2b: The Y Momenta of the Body 1, Body 1, and Body 3", font = cm)
plt.xlabel("Time (s)", font = cm)
plt.ylabel("Momentum (kgm/s)", font = cm)
plt.plot(time_array, momentum_1[1, 1:], label = "Y Momentum of the Body 1")
plt.plot(time_array, momentum_2[1, 1:], label = "Y Momentum of the Body 2")
plt.plot(time_array, momentum_3[1, 1:], label = "Y Momentum of the Body 3")
