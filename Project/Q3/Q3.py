...
fig_2 = plt.figure()
plt.title("Figure 3: The Momenta of Both Bodies", font = cm)
...
fig.legend()
ax.set_title("Figure 3: Unstable System of Two Bodies Orbiting Each Other", font = cm)
