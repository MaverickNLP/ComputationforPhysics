...
positions_3[0:3,0] = [7.405e11+0.265e9,-1.7873e9,0]
...
fig.legend()
ax.set_title("Figure 5b: Voyager's Slingshot around Jupiter", font = cm)
...
def update(frame):
	...
	line_3 = plot_mass_3_1.set_data_3d(positions_3[0,:cur_frame_ind], positions_3[1,:cur_frame_ind],positions_3[2,
	:cur_frame_ind])
	return line_2, line_3, point_2, point_3

ani = animation.FuncAnimation(fig, update,frames)

ani.save("Q4 (P36): Jupiter Slingshot Failed.gif", fps = 120)