...
fig_2 = plt.figure()
plt.title("Figure 4: The Momenta of Both Bodies, with one far heavier than the other", font = cm)
...
fig.legend()
ax.set_title("Figure 4: Stable System of Two Bodies Orbiting Each Other", font = cm)
...
def update(frame):
	...
	line_3 = plot_mass_3_1.set_data_3d(positions_3[0,:cur_frame_ind], positions_3[1,:cur_frame_ind],positions_3[2,:cur_frame_ind])
	return line_2, line_3, point_2, point_3

ani = animation.FuncAnimation(fig, update,frames)


ani.save("Q4.gif", fps = 120)