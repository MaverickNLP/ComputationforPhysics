...
positions_1[0:3,0] = [-0.97000436, 0.24308753, 0]
positions_2[0:3,0] = [0.97000436, -0.24308753,0]
positions_3[0:3,0] = [0, 0, 0]
...
fig.legend()
ax.set_title("Figure 1: Stable 8 Figure 3 Body Problem", font = cm)
...
def update(frame):
	...
	line_1 = plot_mass_1_1.set_data_3d(positions_1[0,cur_frame_ind-3500:cur_frame_ind], positions_1[1,cur_frame_ind-3500:cur_frame_ind],positions_1[2,cur_frame_ind-3500:cur_frame_ind])
...
ani.save("Figure 1new: Stable 8 Figure 3 Body Problem.gif", fps = 15)
plt.show()
